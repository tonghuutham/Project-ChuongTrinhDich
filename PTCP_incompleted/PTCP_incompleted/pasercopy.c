...
void compileParams(void) {
  ...
  case SB_LPAR:
      ...
      eat(SB_RPAR);
      break;
  case SB_COLON:   //follow của Param trong Fundecl 
  case SB_SEMICOLON:  //follow của Param trong ProcDecl
      break;
  default:
...
void compileParams2(void) {
  ...
  case SB_SEMICOLON:
      ...
      compileParams2();
      break;
  case SB_RPAR:    //follow của Params2 trong Params
      break;
  default:
      error(ERR_INVALIDPARAM, lookAhead->lineNo, lookAhead->colNo);
      break;
...
void compileStatement(void) {
  ...
  case TK_IDENT:
  eat(TK_IDENT);
  if ( lookAhead->tokenType ==SB_ASSIGN || lookAhead->tokenType == SB_LSEL) {
       compileAssignSt();
  }
    else {
        compileCallSt();
